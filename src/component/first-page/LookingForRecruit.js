...
function LookingForRecruit(){
  return(
    <section className="RecruitMenu Section_Wrapper_9in1">
      <div className="recruit_header set_center">
        <h2>채용정보를 찾고계셨나요?</h2>
      </div>
      <div className="recruit_menu_grid">
        <div className="recruit_item">
          <a className="recruit_item_icon" data-attribute-id="home__recruit__click" data-kind="position" href="/wdlist">
            <span className="SvgIconRoot">
              <svg className="root__svg__DKYBi" viewBox="0 0 32 32">
          ...
          <a href="/wdlist" className="recruit_item_text set_center" aria-label="" data-attribute-id="home__recruit__click" data-kind="position">
            <span className="sub_button_label">채용공고
              <span className="recruit_item_endicon SvgIconRoot">
        ...
        <div className="recruit_item">
          <a className="recruit_item_icon" data-attribute-id="home__recruit__click" data-kind="profile" href="/profile">
            <span className="SvgIconRoot">
              <svg className="root__svg__DKYBi" viewBox="0 0 32 32">
          ...
          <a href="/profile" className="recruit_item_text set_center" aria-label="" data-attribute-id="home__recruit__click" data-kind="profile">
            <span className="sub_button_label">내 프로필
              <span className="recruit_item_endicon SvgIconRoot">
                <svg className="root__svg__DKYBi" viewBox="0 0 18 18">
                  <path d="m11.955 9-5.978 5.977a.563.563 0 0 0 .796.796l6.375-6.375a.563.563 0 0 0 0-.796L6.773 2.227a.562.562 0 1 0-.796.796L11.955 9z"></path>
                </svg>
        ...
        <div className="recruit_item">
          <a className="recruit_item_icon" data-attribute-id="home__recruit__click" data-kind="matchup" href="/matchup/intro">
            <span className="SvgIconRoot">
              <svg className="root__svg__DKYBi" viewBox="0 0 32 32">
          ...
          <a href="/profile" className="recruit_item_text set_center" aria-label="" data-attribute-id="home__recruit__click" data-kind="matchup">
            <span className="sub_button_label">매치업
              <span className="recruit_item_endicon SvgIconRoot">
                <svg className="root__svg__DKYBi" viewBox="0 0 18 18">
                  <path d="m11.955 9-5.978 5.977a.563.563 0 0 0 .796.796l6.375-6.375a.563.563 0 0 0 0-.796L6.773 2.227a.562.562 0 1 0-.796.796L11.955 9z"></path>
                </svg>
        ...
        <div className="recruit_item_end">
          <a className="recruit_item_icon" data-attribute-id="home__recruit__click" data-kind="salary" href="/salary">
            <span className="SvgIconRoot">
              <svg className="root__svg__DKYBi" viewBox="0 0 32 32">
          ...
          <a href="/profile" className="recruit_item_text set_center" aria-label="" data-attribute-id="home__recruit__click" data-kind="matchup">
            <span className="sub_button_label">직군별 연봉
              <span className="recruit_item_endicon SvgIconRoot">
                <svg className="root__svg__DKYBi" viewBox="0 0 18 18">
                  <path d="m11.955 9-5.978 5.977a.563.563 0 0 0 .796.796l6.375-6.375a.563.563 0 0 0 0-.796L6.773 2.227a.562.562 0 1 0-.796.796L11.955 9z"></path>
                </svg>
...
export default LookingForRecruit;