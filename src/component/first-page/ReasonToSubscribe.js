function ReasonToSubscribe() {
  return (
    <section className="sub make_space">
      <div className="Section_Wrapper_9in1 sub_grid">
        <div className="sub_titleArea">
          <div className="sub_title">
            <span className="SvgIconRoot sub_title_logo">
              <svg className="root__svg__DKYBi" viewBox="0 0 160 31">
                <path
            ...
            <div className="sub_title_text">구독해야하는 이유</div>
          </div>
          <p>
...
export default ReasonToSubscribe;
