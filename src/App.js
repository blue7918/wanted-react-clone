...
import CareerContentList from './component/first-page/CareerContentList';
import ThreeMinuteVOD from './component/first-page/ThreeMinuteVOD';
import ForWorkerVOD from './component/first-page/ForWorkerVOD';
